...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "1653093114:AAHyd4cAbuvleyPBYWds8DavLIV3Fnt1uzo")
    ...
    AUTH_CHANNEL = set(int(x) for x in os.environ.get("AUTH_CHANNEL", "1001474921230").split())
    ...
    DEF_THUMB_NAIL_VID_S = os.environ.get("DEF_THUMB_NAIL_VID_S", "https://telegra.ph/file/f0fc1ca20e08d638195b9.jpg")
